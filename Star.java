...
public class Star implements Comparable<Star> {
	...
	public int compareTo(Star other) {
		if(this.getZ() != other.getZ()) {
			return (int) (Math.signum(this.getZ() - other.getZ()));
		}else if(this.getY() != other.getY()){
			return (int) (Math.signum(this.getY() - other.getY()));
		}else if(this.getX() != other.getX()) {
			return (int) (Math.signum(this.getX() - other.getX()));
		}else if(this.getMagnitude() != other.getMagnitude()){
		    return (int) (Math.signum(this.getMagnitude() - other.getMagnitude()));
		}else{
		    return 0;
		}
	...
	public boolean equals(Object object) {
		...
		return this.getX() == other.getX() && this.getY() == other.getY() && this.getZ() == other.getZ() && this.getMagnitude() == other.getMagnitude();
